...
REASON — обязательно указать ОДНО ИЗ:
- "CASE_X полностью покрывает ситуацию"
- "CASE_X покрывает ситуацию частично"
- "Подходящий CASE не найден, нужен новый кейс: <кратко какой>"
- "Недостаточно данных от пользователя для выбора CASE"
