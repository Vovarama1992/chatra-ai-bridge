...
Тебе надо будет выбрать кейс, но сначала ты ОБЯЗАН проверить CLIENT INFO и CLIENT INTEGRATION DATA.
...
выбираешь РОВНО ОДИН главный CASE_*.
Другие кейсы можно использовать ТОЛЬКО если их правила НЕ противоречат главному.
Если противоречат — игнорировать.
